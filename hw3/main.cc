...
int main (int argc, const char * argv[])
{
    ...
    Camera cam;
    Parser parser;
//    parser.parse ("/Users/lindashen/Desktop/Columbia University/2016 Fall/Computer Science/Computer Graphics/Assignments/03_10_20/scene_file.txt", surfaces, lights, materials, cam);
